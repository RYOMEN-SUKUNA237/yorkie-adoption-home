...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1583512603805-3cc6b41f3edb?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1591160690555-5debfba289f0?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1552053831-71594a27632d?w=900&h=1100&fit=crop&auto=format']::text[], 0,
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1596492784531-6e6eb5ea9993?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?w=900&h=1100&fit=crop&auto=format']::text[], 1,
  (select id from public.parents where name = 'Ch. Brightwater Sixpence' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Silverthorn Penny Royal' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1560807707-8cc77767d783?w=900&h=1100&fit=crop&auto=format']::text[], 2,
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1601979031925-424e53b6caaa?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1583512603805-3cc6b41f3edb?w=900&h=1100&fit=crop&auto=format']::text[], 3,
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1591160690555-5debfba289f0?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1568572933382-74d440642117?w=900&h=1100&fit=crop&auto=format']::text[], 4,
  (select id from public.parents where name = 'Gr. Ch. Copperfield Bold As Brass' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Silverthorn Penny Royal' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1552053831-71594a27632d?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1596492784531-6e6eb5ea9993?w=900&h=1100&fit=crop&auto=format']::text[], 5,
  (select id from public.parents where name = 'Ch. Wharfedale Little Admiral' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Moorland Tuppence' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1560807707-8cc77767d783?w=900&h=1100&fit=crop&auto=format']::text[], 6,
  (select id from public.parents where name = 'Ch. Brightwater Sixpence' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Harrogate Blue Ribbon' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1568572933382-74d440642117?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1601979031925-424e53b6caaa?w=900&h=1100&fit=crop&auto=format']::text[], 7,
  (select id from public.parents where name = 'Ch. Wharfedale Little Admiral' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Silverthorn Penny Royal' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1583512603805-3cc6b41f3edb?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?w=900&h=1100&fit=crop&auto=format']::text[], 8,
  (select id from public.parents where name = 'Gr. Ch. Copperfield Bold As Brass' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Moorland Tuppence' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1596492784531-6e6eb5ea9993?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1552053831-71594a27632d?w=900&h=1100&fit=crop&auto=format']::text[], 9,
  (select id from public.parents where name = 'Ch. Brightwater Sixpence' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Moorland Tuppence' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1560807707-8cc77767d783?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1591160690555-5debfba289f0?w=900&h=1100&fit=crop&auto=format']::text[], 10,
  (select id from public.parents where name = 'Ch. Wharfedale Little Admiral' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Harrogate Blue Ribbon' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1601979031925-424e53b6caaa?w=900&h=1100&fit=crop&auto=format', 'https://images.unsplash.com/photo-1568572933382-74d440642117?w=900&h=1100&fit=crop&auto=format']::text[], 11,
  (select id from public.parents where name = 'Gr. Ch. Copperfield Bold As Brass' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Silverthorn Penny Royal' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1591160690555-5debfba289f0?w=900&h=1100&fit=crop&auto=format']::text[], 12,
  (select id from public.parents where name = 'Ch. Brightwater Sixpence' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Harrogate Blue Ribbon' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1552053831-71594a27632d?w=900&h=1100&fit=crop&auto=format']::text[], 13,
  (select id from public.parents where name = 'Ch. Wharfedale Little Admiral' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Moorland Tuppence' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.puppies (
  ...
  array['https://images.unsplash.com/photo-1583512603805-3cc6b41f3edb?w=900&h=1100&fit=crop&auto=format']::text[], 14,
  (select id from public.parents where name = 'Gr. Ch. Copperfield Bold As Brass' and role = 'sire'),
  (select id from public.parents where name = 'Ch. Harrogate Blue Ribbon' and role = 'dam')
)
on conflict (slug) do update set
...
insert into public.site_settings (key, value, is_public) values
  ...
  ('whatsapp_number', '"447700900000"'::jsonb, true),
